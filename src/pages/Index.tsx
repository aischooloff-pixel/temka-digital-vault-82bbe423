        ...
        <div className="container-main mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              { icon: Headphones, title: 'Поддержка 24/7', desc: 'Наша команда поддержки доступна круглосуточно через Telegram для помощи с любыми вопросами.' },
        ...
        <div className="container-main mx-auto">
          <div className="relative p-6 sm:p-8 md:p-12 rounded-2xl border border-primary/20 bg-primary/5 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-muted-foreground text-sm mt-2 max-w-md mx-auto">Наша команда поддержки доступна 24/7. Свяжитесь через Telegram.</p>
